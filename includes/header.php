        ...
        <div class="info-section">
            ...
            <div class="flex-end">
                ...
                <div class="round" >
                    ...
                    <img src="/assets/logo/instagram.png" alt="Instagram" ></a>
                        </div>
                        <div class="round">
                          <a href="https://www.facebook.com/">
                              <img src="/assets/logo/facebook.png" alt="Facebook"> </a>

                        </div>
                        <a href="/register.php" style="color:inherit; text-decoration:none;">
                            <h6>Register Now</h6>
                        </a>
            ...
            <div class="container">
                <div class="search-section">
                    ...
                    <div class="logo-section">
                        <a href="/index.php"><img src="/assets/logo/greeny.png" alt="Greeny Logo"></a>
                    </div>
                    <form action="/pages/search.php" method="GET" class="search-location">
                ...
                <div class="wishlist-flex">
                    ...
                    <a href="/pages/cart/cart.php" class="cart-link">
                    <div class="cart">
                    ...
                    <div class="account">
                         <img src="/assets/logo/profile.svg"/>
                       
                        <div class="account-dropdown">
                        <a href="/pages/account/my_account.php"><h6>My Account</h6></a>
                ...
                <a href="/pages/products/products.php">
                    <div class="department">
                        ...
                        <div class="elements-a">
                            ...
                            <a href="/pages/products/products.php">Shop</a>
                            <a href="/pages/offers/offers.php">Offers</a>
                           
                            <a href="/pages/contactus/contact_us.php">Contact Us</a>
                    ...
                    <div class="element2">
                    <a href="/pages/products/products.php?deal=Deal+of+the+Day">
